      ...
      <div className="relative max-w-6xl mx-auto">
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center mb-12">
          {!showAuthButtons ? (
            <Button
              size="lg"
              className="bg-gradient-to-r from-violet-600 to-blue-600 hover:from-violet-700 hover:to-blue-700 text-white px-8 py-3 rounded-full shadow-lg hover:shadow-xl transition-all duration-300 group"
            ...
            <div className="flex gap-3">
              <Button
                variant="outline"
                size="lg"
                className="rounded-full px-6 py-3 border-slate-600 text-slate-200 hover:bg-slate-800/60 transition-all duration-200"
              >
                Login
              </Button>
              <Button
                variant="secondary"
                size="lg"
                className="rounded-full px-6 py-3 bg-slate-700 text-white hover:bg-slate-600 transition-all duration-200"
              >
                Register
              </Button>
            </div>
